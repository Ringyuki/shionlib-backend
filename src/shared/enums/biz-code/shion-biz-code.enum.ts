...
export enum ShionBizCode {
  ...
  // 47
  GAME_UPLOAD_INVALID_TOTAL_SIZE = 470101,
  GAME_UPLOAD_TOO_MANY_CHUNKS = 470102,
  GAME_UPLOAD_TOO_LARGE = 470103,
  GAME_UPLOAD_SESSION_NOT_FOUND = 470104,
  GAME_UPLOAD_INVALID_SESSION_STATUS = 470105,
  GAME_UPLOAD_UNEXPECTED_CONTENT_LENGTH = 470106,
  GAME_UPLOAD_INVALID_CHUNK_SHA256 = 470107,
  GAME_UPLOAD_CHUNK_SHA256_MISMATCH = 470108,
  GAME_UPLOAD_INCOMPLETE = 470109,
  GAME_UPLOAD_FILE_SHA256_MISMATCH = 470110,
  GAME_UPLOAD_INVALID_CHUNK_INDEX = 470111,
  GAME_UPLOAD_SESSION_EXPIRED = 470112,
  GAME_UPLOAD_SESSION_NOT_OWNER = 470113,

  // 48
  SMALL_FILE_UPLOAD_FILE_SIZE_EXCEEDS_LIMIT = 480101,
  SMALL_FILE_UPLOAD_FILE_NO_FILE_PROVIDED = 480102,
  SMALL_FILE_UPLOAD_UNSUPPORTED_FILE_TYPE = 480103,

  // 49
  USER_UPLOAD_QUOTA_NOT_FOUND = 490101,
  USER_UPLOAD_QUOTA_EXCEEDED = 490102,
  USER_UPLOAD_QUOTA_USE_CANT_BE_NEGATIVE = 490103,
  USER_UPLOAD_QUOTA_RECORD_NOT_FOUND = 490104,
}
